...
local function makeDraggable(frame, dragHandle)
    ...
    -- Safety: stop drag if input ends globally
...
function ArabyHub:CreateMainWindow(options)
    ...
    if bgImage then
        ...
        bgImg.ScaleType = Enum.ScaleType.Fill
        bgImg.ZIndex = 0
...
function ArabyHub:Init(options)
    ...
    self:ShowSplash(function()
        ...
        local toggleRoot, toggleBtn = self:CreateToggleButton(options)
        ...
        self.AddContent = function(element)
